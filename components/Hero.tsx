...
const Hero = () => {
	return (
		<div className=' pb-20 pt-36' id='home'>
			...
			<div
				className='h-screen w-full dark:bg-black-100 dark:bg-grid-white/[0.03] bg-grid-black-100/[0.03]
         ...
         [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]'
			...
			<div className='flex justify-center relative my-0 z-10 '>
				<div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
					<p className='uppercase tracking-widest text-xs text-center text-pink-100 max-w-80'>
						Innovative Full Stack Solutions
					</p>

					<TextGenerateEffect
						words='Empowering Ideas with Code & Creativity'
						className='text-center text-[44px] md:text-6xl lg:text-7xl'
					/>
